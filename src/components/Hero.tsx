    ...
    <section id="home" className="min-h-screen flex items-center bg-[#0B0B12] pt-[50px]">
      <div className="w-full max-w-7xl mx-auto px-6">
        <div className="relative bg-white rounded-3xl shadow-lg p-8 overflow-hidden">
          ...
          <div className="absolute bottom-2 left-2">
            <div className="bg-black w-32 h-24 rounded-tr-[50px] rounded-bl-[50px] relative z-0 transform  origin-center">
              <div className="absolute bottom-2 left-2 bg-white w-28 h-20 rounded-tr-[40px] rounded-bl-[40px] rounded-br-[10px] rounded-tl-[10px] flex items-center justify-center border border-gray-200 shadow-md">
                <span className="font-semibold text-black">CV</span>
              </div>
            </div>
          </div>
